 ...
 * @param {StatOptions & { bigint?: false }} [opts]
 * Options to pass to stat. If bigint is set to false or omitted, the size is returned as a number.
 * @param {StatOptions & { bigint: true }} [opts]
 * Options to pass to stat. If bigint is set to true, the size is returned as a BigInt.
 * @returns {Promise<number | bigint | undefined>}
 * A promise that resolves to the size of the file in bytes, or undefined if the file does not exist or an error occurs.
 */
 ...
 *
 * @param {PathLike} path - The path to the file.
 * @param {StatSyncOptions & { bigint?: false }} [options]
 * Options to pass to statSync. If bigint is set to false or omitted, the size is returned as a number.
 * @param {StatSyncOptions & { bigint: true }} [options]
 * Options to pass to statSync. If bigint is set to true, the size is returned as a BigInt.
 * @returns {number | bigint | undefined}
 * The size of the file in bytes, or undefined if the file does not exist or an error occurs.
 */
 ...
 * A promise that resolves to true if the path is a block device, otherwise false,
 * or undefined if the path does not exist or an error occurs.
 */
 ...
 * Returns true if the path is a block device, otherwise false,
 * or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {Promise<boolean | undefined>}
 * A promise that resolves to true if the path is a character device, otherwise false,
 * or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {boolean | undefined}
 * Returns true if the path is a character device, otherwise false,
 * or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {boolean | undefined}
 * Returns true if the path is a directory, otherwise false, or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {Promise<boolean | undefined>}
 * A promise that resolves to true if the path is a FIFO, otherwise false,
 * or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {boolean | undefined}
 * Returns true if the path is a FIFO, otherwise false, or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {Promise<boolean | undefined>}
 * A promise that resolves to true if the path is a file, otherwise false,
 * or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {boolean | undefined}
 * Returns true if the path is a file, otherwise false, or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {Promise<boolean | undefined>}
 * A promise that resolves to true if the path is a socket, otherwise false,
 * or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {boolean | undefined}
 * Returns true if the path is a socket, otherwise false, or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {PathLike} path - The path to check.
 * @returns {Promise<boolean | undefined>}
 * A promise that resolves to true if the path is a symbolic link, otherwise false,
 * or undefined if the path does not exist or an error occurs.
 */
 ...
 * @param {ObjectEncodingOptions & Abortable & { flag?: OpenMode } | BufferEncoding | null} [options]
 * The options for reading the file.
 * @returns {Promise<Blob | undefined>}
 * A promise that resolves to a Blob containing the file contents, or undefined if an error occurs.
 */
// @ts-expect-error Ignore this error.
export async function readFileToBlob(
    path: fsp.FileHandle | PathLike,
    options?: (Abortable & { encoding?: null; flag?: OpenMode }) | null
): Promise<Blob | undefined>;
export async function readFileToBlob(
    path: fsp.FileHandle | PathLike,
    options: (Abortable & { encoding: BufferEncoding; flag?: OpenMode }) | BufferEncoding
): Promise<Blob | undefined>;
export async function readFileToBlob(
    path: fsp.FileHandle | PathLike,
    options?: (Abortable & ObjectEncodingOptions & { flag?: OpenMode }) | BufferEncoding | null
): Promise<Blob | undefined>;
 ...
 * @param {ObjectEncodingOptions & { flag?: string } | BufferEncoding | null} [options]
 * The options for reading the file.
...
export function readFileToBlobSync(
    path: PathOrFileDescriptor,
    options?: BufferEncoding | null | (ObjectEncodingOptions & { flag?: string })
): Blob | undefined;
